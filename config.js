...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "MNS Pools and Ponds Specialist CC",
    phone:     "+27 72 634 2188",
    whatsapp:  "+27 72 634 2188",
    address:   "Sandton and surrounding areas, Randburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "MNS Pools and Ponds Specialist CC — Pool services in randburg",
    description: "MNS Pools and Ponds Specialist CC provides professional pool services in Randburg. 6 Google reviews. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Pool services · Randburg & surrounds",
    heroTitle:  "Crystal-clear water — <em>all year round.</em>",
    heroLead:   "MNS Pools and Ponds Specialist CC keeps swimming pools clean, chemically balanced and fully functional across Randburg. Maintenance, repairs, pump and filter work — we handle it all.",
    ...
    band: {
      ...
      alt:   "MNS Pools and Ponds Specialist CC team at work in Randburg",
      text:  "Pool installation, maintenance and repairs — we keep your pool perfect."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Serving pools across Randburg and surrounds.",
    areasLead:  "We cover Randburg, Northcliff, Cresta and the surrounding areas. Maintenance contracts available throughout the service area.",
